...
function ProjectDetails() {
  ...
  // =========================================================
  // CUSTOM DYNAMIC TABLE (Project Information Table)
  // =========================================================
  // Ye wahi table hai jo Admin "Add Project" form me
  // DynamicTable component se fill karta hai.
  // Isme columns + rows dono hote hain.
  // =========================================================
 
  const customTableColumns = Array.isArray(
    project?.customTable?.columns
  )
    ? project.customTable.columns
    : [];
 
  const customTableRows = Array.isArray(
    project?.customTable?.rows
  )
    ? project.customTable.rows
    : [];
 
  const hasCustomTable =
  ...
  return (
    <>
      {/* =====================================================
          NAVBAR — overflow-x-hidden ke BAHAR rakhna zaroori hai
          warna sticky kaam nahi karta
      ====================================================== */}
        ...
        <div className="mx-auto w-full min-w-0 max-w-7xl px-3 py-5 sm:px-5 sm:py-10 lg:px-8 lg:py-14">
          ...
          <div className="grid min-w-0 gap-5 sm:gap-7 lg:grid-cols-[minmax(0,1fr)_340px]">
            ...
            <div className="min-w-0 space-y-5 sm:space-y-7">
              ...
              {/* =============================================
                  CUSTOM PROJECT INFORMATION TABLE
                  (Admin ke DynamicTable component se aaya data)
              ============================================== */}
...
function DetailItem({
  ...
  // Agar value hi nahi hai (empty/undefined), field ko chhupa do
  // taaki blank "—" cards zyada na dikhein.
  if (
    value === undefined ||
    value === null ||
    value === ""
